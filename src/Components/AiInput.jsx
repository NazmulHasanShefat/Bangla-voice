...
const AiInput = () => {
  ...
  const handleListen = () => {
    ...
    isListening ? speechRecognition.stop() : speechRecognition.start();
  };
    ...
    <div className="w-full max-w-2xl mx-auto p-4">
      <div className="relative p-[2px] rounded-xl bg-gradient-to-r from-blue-500 via-blue-800 to-purple-500 shadow-lg">
        <div className="bg-gray-900 rounded-xl p-6 flex items-start gap-4">
          ...
          /> */}
          <div
            className={`${text ? "" : "ai-input"} text-lg flex-1 bg-gray-800 text-white placeholder-gray-400 resize-none outline-none max-h-48 overflow-y-auto rounded-lg transition`}
          ...
          <div className="flex gap-2 text-white">
            <button
              ...
              className={`p-2 rounded-full border-2 border-gray-600 hover:bg-gray-800 transition duration-200 ${isListening ? "animate-pulse border-purple-500 bg-purple-500/20" : ""}`}
            >
              <Mic size={18} />
            </button>
            <button
